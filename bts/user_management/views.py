...
def pre_login(request):
        ...
        return render_to_response("login.html",{'msg': "", 'direccion':dir}, context_instance=RequestContext(request))
...
def registrarse(request):
        ...
        if request.method == "GET": # Metodo GET, se va a registrar.
                ...
                return render_to_response("registrarse.html", {'direccion':dir,'msg': "", 'f': f}, # Y se lo paso a la plantilla.
			...
			try:
					...
					u.save()
                                        return render_to_response("login.html", {'direccion':dir,'msg': "Usuario ya creado!!"},
                                              context_instance=RequestContext(request))
                else:
                        return render_to_response("registrarse.html",{'direccion':dir, 'msg': "Uno de sus datos no tiene el formato adecuado",'f': FormularioRegistro()})
